...
import { Home, UserPlus, Settings, Users, LucideFileUp, UserCog,Mail,FileDiff } from 'lucide-react';
  ...
  const menuitems = (role) => {
    ...
    if (role === 'COMITE') {
      items.push(
        ...
        { id: 'rubric', icon: FileDiff, label: 'Citerios Evaluacion', page: `${baseUrl}/rubric` },
